										...
										<div class="card-body loadmore-content dz-scroll recent-activity-wrapper px-3  py-3" id="RecentActivityContent">
											<div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
												<span class="me-3 me-lg-2">
													<img :src="`${imgUrl}/assets/images/profile/small/pic1.jpg`" alt="" width="50">
												</span>
												<div class="ms-2">
											...
											<div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
												<span class="me-3 me-lg-2">
													<img :src="`${imgUrl}/assets/images/profile/small/pic2.jpg`" alt="" width="50">
												</span>
												<div class="ms-2">
											...
											<div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
												<span class="me-3 me-lg-2">
													<img :src="`${imgUrl}/assets/images/profile/small/pic3.jpg`" alt="" width="50">
												</span>
												<div class="ms-2">
											...
											<div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
												<span class="me-3 me-lg-2">
													<img :src="`${imgUrl}/assets/images/profile/small/pic4.jpg`" alt="" width="50">
												</span>
												<div class="ms-2">
											...
											<div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
												<span class="me-3 me-lg-2">
													<img :src="`${imgUrl}/assets/images/profile/small/pic5.jpg`" alt="" width="50">
												</span>
												<div class="ms-2">
											...
											<div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
												<span class="me-3 me-lg-2">
													<img :src="`${imgUrl}/assets/images/profile/small/pic6.jpg`" alt="" width="50">
												</span>
												<div class="ms-2">
													<h6 class="font-w500 fs-16 mb-0"><a href="app-profile.html">Dedi Cahyadi</a></h6>
													<span class="fs-14 font-w400 text-wrap">Head Manager</span>
